...
public class MapQ2 extends Mapper<LongWritable, Text, Text, DoubleWritable>{
	...
	/**
	 * Overriding map method to look for education levels in females in the US
	 * Gets %net enrollment for females 2000-2016 at primary and tertiary levels
	 * Gets %gross enrollment at tertiary level since %net is not available
	 * 
	 * output is the percent of female enrollment for each year
	 */
	@Override
	protected void map(LongWritable key, Text value, Mapper<LongWritable, Text, Text, DoubleWritable>.Context context)
		...
		if(l.contains("USA") && l.contains("School enrollment")) {
			try {
